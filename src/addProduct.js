...
class addProduct extends React.Component {
    ...
    handleSubmit = e => {
        ...
        fetch(`http://localhost:1234/prduct`, {
            method: 'POST',
            headers: {
    ...
    render() {
        ...
        return <form onSubmit={this.handleSubmit} onChange={this.handlChange}>
            ...
            <section>
                ...
                <input type='radio' name='brand' />b<br />
                <input type='radio' name='brand' />c<br />
            </section>
            <section>
                <label>Department:</label><br />
                <input type='radio' name='department' value='j' required />d<br />
                <input type='radio' name='department' />e <br />
            </section>
            <section>
                <label>Category:</label><br />
                <input type='radio' name='category' value='j' required />f<br />
                <input type='radio' name='category' />v <br />
            </section>
            <section>
                <label>Tags:</label><br />
                <input type='checkbox' name='tags' value='j' required />g<br />
                <input type='checkbox' name='tags'  />j <br />
            </section>
